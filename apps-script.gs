 ...
 *
 *   6. Deploy ← New deployment ← בגלגל השיניים בחרו Web app.
 *        Execute as:        Me
 *        Who has access:    Anyone
 *      לחצו Deploy והעתיקו את כתובת ה-Web app שמתקבלת.
 *      היא נראית כך: https://script.google.com/macros/s/AKfycb.../exec
 *   7. שלחו את הכתובת לארז. היא נכנסת למשתנה ENDPOINT בראש index.html.
 *
 * שימו לב: אחרי כל שינוי בקוד צריך Deploy ← Manage deployments ← עריכה ←
 * Version: New version, אחרת הכתובת ממשיכה להריץ את הגרסה הישנה.
 *
